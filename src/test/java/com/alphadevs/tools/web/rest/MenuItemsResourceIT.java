...
import com.alphadevs.tools.repository.MenuItemsRepository;
import com.alphadevs.tools.service.MenuItemsService;
import com.alphadevs.tools.web.rest.errors.ExceptionTranslator;
import com.alphadevs.tools.service.dto.MenuItemsCriteria;
import com.alphadevs.tools.service.MenuItemsQueryService;
...
public class MenuItemsResourceIT {
    ...
    public void createMenuItems() throws Exception {
        ...
        assertThat(testMenuItems.isIsFavorite()).isEqualTo(DEFAULT_IS_FAVORITE);
    ...
    @Test
    @Transactional
    public void getAllMenuItemsByIsFavoriteIsEqualToSomething() throws Exception {
        // Initialize the database
        menuItemsRepository.saveAndFlush(menuItems);

        // Get all the menuItemsList where isFavorite equals to DEFAULT_IS_FAVORITE
        defaultMenuItemsShouldBeFound("isFavorite.equals=" + DEFAULT_IS_FAVORITE);

        // Get all the menuItemsList where isFavorite equals to UPDATED_IS_FAVORITE
        defaultMenuItemsShouldNotBeFound("isFavorite.equals=" + UPDATED_IS_FAVORITE);
    }

    @Test
    @Transactional
    public void getAllMenuItemsByIsFavoriteIsNotEqualToSomething() throws Exception {
        // Initialize the database
        menuItemsRepository.saveAndFlush(menuItems);

        // Get all the menuItemsList where isFavorite not equals to DEFAULT_IS_FAVORITE
        defaultMenuItemsShouldNotBeFound("isFavorite.notEquals=" + DEFAULT_IS_FAVORITE);

        // Get all the menuItemsList where isFavorite not equals to UPDATED_IS_FAVORITE
        defaultMenuItemsShouldBeFound("isFavorite.notEquals=" + UPDATED_IS_FAVORITE);
    }

    @Test
    @Transactional
    public void getAllMenuItemsByIsFavoriteIsInShouldWork() throws Exception {
        // Initialize the database
        menuItemsRepository.saveAndFlush(menuItems);

        // Get all the menuItemsList where isFavorite in DEFAULT_IS_FAVORITE or UPDATED_IS_FAVORITE
        defaultMenuItemsShouldBeFound("isFavorite.in=" + DEFAULT_IS_FAVORITE + "," + UPDATED_IS_FAVORITE);

        // Get all the menuItemsList where isFavorite equals to UPDATED_IS_FAVORITE
        defaultMenuItemsShouldNotBeFound("isFavorite.in=" + UPDATED_IS_FAVORITE);
    }

    @Test
    @Transactional
    public void getAllMenuItemsByIsFavoriteIsNullOrNotNull() throws Exception {
        // Initialize the database
        menuItemsRepository.saveAndFlush(menuItems);

        // Get all the menuItemsList where isFavorite is not null
        defaultMenuItemsShouldBeFound("isFavorite.specified=true");

        // Get all the menuItemsList where isFavorite is null
        defaultMenuItemsShouldNotBeFound("isFavorite.specified=false");
    }
    ...
    public void updateMenuItems() throws Exception {
        ...
        assertThat(testMenuItems.isIsFavorite()).isEqualTo(UPDATED_IS_FAVORITE);
