...
public class EmployeeResourceIT {
    ...
    private static final String DEFAULT_KNOWN_NAME = "AAAAAAAAAA";
    private static final String UPDATED_KNOWN_NAME = "BBBBBBBBBB";

    private static final String DEFAULT_EMAIL = "yvR`;;@J!rM7X.;y9CS";
    private static final String UPDATED_EMAIL = ")*>@YG&.:4_";
    ...
    public void createEmployee() throws Exception {
        ...
        assertThat(testEmployee.getKnownName()).isEqualTo(DEFAULT_KNOWN_NAME);
    ...
    public void getAllEmployees() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].empNumber").value(hasItem(DEFAULT_EMP_NUMBER)))
            .andExpect(jsonPath("$.[*].firstName").value(hasItem(DEFAULT_FIRST_NAME)))
            .andExpect(jsonPath("$.[*].lastName").value(hasItem(DEFAULT_LAST_NAME)))
            .andExpect(jsonPath("$.[*].knownName").value(hasItem(DEFAULT_KNOWN_NAME)))
    ...
    public void getEmployee() throws Exception {
        ...
        restEmployeeMockMvc.perform(get("/api/employees/{id}", employee.getId()))
            ...
            .andExpect(jsonPath("$.empNumber").value(DEFAULT_EMP_NUMBER))
            .andExpect(jsonPath("$.firstName").value(DEFAULT_FIRST_NAME))
            .andExpect(jsonPath("$.lastName").value(DEFAULT_LAST_NAME))
            .andExpect(jsonPath("$.knownName").value(DEFAULT_KNOWN_NAME))
    ...
    @Test
    @Transactional
    public void getAllEmployeesByEmpNumberIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber equals to DEFAULT_EMP_NUMBER
        defaultEmployeeShouldBeFound("empNumber.equals=" + DEFAULT_EMP_NUMBER);

        // Get all the employeeList where empNumber equals to UPDATED_EMP_NUMBER
        defaultEmployeeShouldNotBeFound("empNumber.equals=" + UPDATED_EMP_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEmployeesByEmpNumberIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber not equals to DEFAULT_EMP_NUMBER
        defaultEmployeeShouldNotBeFound("empNumber.notEquals=" + DEFAULT_EMP_NUMBER);

        // Get all the employeeList where empNumber not equals to UPDATED_EMP_NUMBER
        defaultEmployeeShouldBeFound("empNumber.notEquals=" + UPDATED_EMP_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEmployeesByEmpNumberIsInShouldWork() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber in DEFAULT_EMP_NUMBER or UPDATED_EMP_NUMBER
        defaultEmployeeShouldBeFound("empNumber.in=" + DEFAULT_EMP_NUMBER + "," + UPDATED_EMP_NUMBER);

        // Get all the employeeList where empNumber equals to UPDATED_EMP_NUMBER
        defaultEmployeeShouldNotBeFound("empNumber.in=" + UPDATED_EMP_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEmployeesByEmpNumberIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber is not null
        defaultEmployeeShouldBeFound("empNumber.specified=true");

        // Get all the employeeList where empNumber is null
        defaultEmployeeShouldNotBeFound("empNumber.specified=false");
    }
                @Test
    @Transactional
    public void getAllEmployeesByEmpNumberContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber contains DEFAULT_EMP_NUMBER
        defaultEmployeeShouldBeFound("empNumber.contains=" + DEFAULT_EMP_NUMBER);

        // Get all the employeeList where empNumber contains UPDATED_EMP_NUMBER
        defaultEmployeeShouldNotBeFound("empNumber.contains=" + UPDATED_EMP_NUMBER);
    }

    @Test
    @Transactional
    public void getAllEmployeesByEmpNumberNotContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where empNumber does not contain DEFAULT_EMP_NUMBER
        defaultEmployeeShouldNotBeFound("empNumber.doesNotContain=" + DEFAULT_EMP_NUMBER);

        // Get all the employeeList where empNumber does not contain UPDATED_EMP_NUMBER
        defaultEmployeeShouldBeFound("empNumber.doesNotContain=" + UPDATED_EMP_NUMBER);
    }
    ...
    @Test
    @Transactional
    public void getAllEmployeesByKnownNameIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName equals to DEFAULT_KNOWN_NAME
        defaultEmployeeShouldBeFound("knownName.equals=" + DEFAULT_KNOWN_NAME);

        // Get all the employeeList where knownName equals to UPDATED_KNOWN_NAME
        defaultEmployeeShouldNotBeFound("knownName.equals=" + UPDATED_KNOWN_NAME);
    }

    @Test
    @Transactional
    public void getAllEmployeesByKnownNameIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName not equals to DEFAULT_KNOWN_NAME
        defaultEmployeeShouldNotBeFound("knownName.notEquals=" + DEFAULT_KNOWN_NAME);

        // Get all the employeeList where knownName not equals to UPDATED_KNOWN_NAME
        defaultEmployeeShouldBeFound("knownName.notEquals=" + UPDATED_KNOWN_NAME);
    }

    @Test
    @Transactional
    public void getAllEmployeesByKnownNameIsInShouldWork() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName in DEFAULT_KNOWN_NAME or UPDATED_KNOWN_NAME
        defaultEmployeeShouldBeFound("knownName.in=" + DEFAULT_KNOWN_NAME + "," + UPDATED_KNOWN_NAME);

        // Get all the employeeList where knownName equals to UPDATED_KNOWN_NAME
        defaultEmployeeShouldNotBeFound("knownName.in=" + UPDATED_KNOWN_NAME);
    }

    @Test
    @Transactional
    public void getAllEmployeesByKnownNameIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName is not null
        defaultEmployeeShouldBeFound("knownName.specified=true");

        // Get all the employeeList where knownName is null
        defaultEmployeeShouldNotBeFound("knownName.specified=false");
    }
                @Test
    @Transactional
    public void getAllEmployeesByKnownNameContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName contains DEFAULT_KNOWN_NAME
        defaultEmployeeShouldBeFound("knownName.contains=" + DEFAULT_KNOWN_NAME);

        // Get all the employeeList where knownName contains UPDATED_KNOWN_NAME
        defaultEmployeeShouldNotBeFound("knownName.contains=" + UPDATED_KNOWN_NAME);
    }

    @Test
    @Transactional
    public void getAllEmployeesByKnownNameNotContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where knownName does not contain DEFAULT_KNOWN_NAME
        defaultEmployeeShouldNotBeFound("knownName.doesNotContain=" + DEFAULT_KNOWN_NAME);

        // Get all the employeeList where knownName does not contain UPDATED_KNOWN_NAME
        defaultEmployeeShouldBeFound("knownName.doesNotContain=" + UPDATED_KNOWN_NAME);
    }
    ...
    @Test
    @Transactional
    public void getAllEmployeesByImageURLIsEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);
    ...
    @Test
    @Transactional
    public void getAllEmployeesByImageURLIsNotEqualToSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);

        // Get all the employeeList where imageURL not equals to DEFAULT_IMAGE_URL
        defaultEmployeeShouldNotBeFound("imageURL.notEquals=" + DEFAULT_IMAGE_URL);

        // Get all the employeeList where imageURL not equals to UPDATED_IMAGE_URL
        defaultEmployeeShouldBeFound("imageURL.notEquals=" + UPDATED_IMAGE_URL);
    }

    @Test
    @Transactional
    public void getAllEmployeesByImageURLIsInShouldWork() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);
    ...
    @Test
    @Transactional
    public void getAllEmployeesByImageURLIsNullOrNotNull() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);
        ...
        defaultEmployeeShouldNotBeFound("imageURL.specified=false");
                ...
                @Test
    @Transactional
    public void getAllEmployeesByImageURLContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);
    ...
    @Test
    @Transactional
    public void getAllEmployeesByImageURLNotContainsSomething() throws Exception {
        // Initialize the database
        employeeRepository.saveAndFlush(employee);
    ...
    public void updateEmployee() throws Exception {
        ...
        assertThat(testEmployee.getKnownName()).isEqualTo(UPDATED_KNOWN_NAME);
