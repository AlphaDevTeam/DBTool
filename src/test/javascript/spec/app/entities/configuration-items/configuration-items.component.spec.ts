...
import { ConfigurationItemsComponent } from 'app/entities/configuration-items/configuration-items.component';
...
describe('Component Tests', () => {
  describe('ConfigurationItems Management Component', () => {
    let comp: ConfigurationItemsComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ConfigurationItemsComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      spyOn(service, 'query').and.returnValue(
        of(
          new HttpResponse({
            body: [new ConfigurationItems(123)],
            headers
          })
        )
      );
      ...
      expect(comp.configurationItems && comp.configurationItems[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
