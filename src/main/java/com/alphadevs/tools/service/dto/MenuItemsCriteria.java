...
/**
 * Criteria class for the {@link com.alphadevs.tools.domain.MenuItems} entity. This class is used
 * in {@link com.alphadevs.tools.web.rest.MenuItemsResource} to receive all the possible filtering options from
...
public class MenuItemsCriteria implements Serializable, Criteria {
    ...
    private BooleanFilter isFavorite;
    ...
    public MenuItemsCriteria(MenuItemsCriteria other){
        ...
        this.isFavorite = other.isFavorite == null ? null : other.isFavorite.copy();
    ...
    public BooleanFilter getIsFavorite() {
        return isFavorite;
    }

    public void setIsFavorite(BooleanFilter isFavorite) {
