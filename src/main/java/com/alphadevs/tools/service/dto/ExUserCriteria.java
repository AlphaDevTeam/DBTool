...
/**
 * Criteria class for the {@link com.alphadevs.tools.domain.ExUser} entity. This class is used
 * in {@link com.alphadevs.tools.web.rest.ExUserResource} to receive all the possible filtering options from
...
public class ExUserCriteria implements Serializable, Criteria {
    ...
    public ExUserCriteria(ExUserCriteria other){
        ...
        this.userAuthId = other.userAuthId == null ? null : other.userAuthId.copy();
    }
