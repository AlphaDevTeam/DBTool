...
public class ExUser implements Serializable {
    ...
    @ManyToMany
    @Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
    @JoinTable(name = "ex_user_user_auth",
               joinColumns = @JoinColumn(name = "ex_user_id", referencedColumnName = "id"),
               inverseJoinColumns = @JoinColumn(name = "user_auth_id", referencedColumnName = "id"))
    private Set<ExUserAuth> userAuths = new HashSet<>();
    ...
    public ExUser branches(Set<Branch> branches) {
        this.branches = branches;
        return this;
    }

    public ExUser addBranch(Branch branch) {
        this.branches.add(branch);
        branch.getUsers().add(this);
        return this;
    }

    public ExUser removeBranch(Branch branch) {
    ...
    public Set<ExUserAuth> getUserAuths() {
        return userAuths;
    }

    public ExUser userAuths(Set<ExUserAuth> exUserAuths) {
        this.userAuths = exUserAuths;
        return this;
    }

    public ExUser addUserAuth(ExUserAuth exUserAuth) {
        this.userAuths.add(exUserAuth);
        exUserAuth.getUsers().add(this);
        return this;
    }

    public ExUser removeUserAuth(ExUserAuth exUserAuth) {
        this.userAuths.remove(exUserAuth);
        exUserAuth.getUsers().remove(this);
        return this;
    }

    public void setUserAuths(Set<ExUserAuth> exUserAuths) {
        this.userAuths = exUserAuths;
    }
