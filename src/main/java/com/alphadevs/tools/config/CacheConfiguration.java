package com.alphadevs.tools.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.alphadevs.tools.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.alphadevs.tools.repository.UserRepository.USERS_BY_EMAIL_CACHE);
